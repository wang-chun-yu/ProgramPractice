...
template<> bool sc::transition_actions<&sc::state::event_button, sc::state_off, sc::state_on>::condition(sc::data_model &m)
{
	cout << "is ok : off->on" << endl;
	return true;
}

template<> void sc::transition_actions<&sc::state::event_button, sc::state_off, sc::state_on>::enter(sc::data_model &m)
{
	// while(1)
	// {
		cout << "is running : off->on" << endl;
		// sleep(10);
	// }
}
